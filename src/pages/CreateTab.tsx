...
const CreateTab = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Botflow creat:', response.data);
      navigate(`/flow/${response.data.id}`); // redirigeix, opcional
    } catch (error) {
      console.error('Error creant el botflow:', error);
      alert('No s’ha pogut crear el chatbot');
    }
  };
